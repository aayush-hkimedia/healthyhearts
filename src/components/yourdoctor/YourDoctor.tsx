...
const DoctorPage: React.FC = () => {
    ...
    return (
        <main className="font-sans antialiased text-[#575A5F] bg-white overflow-hidden">
            <section className="relative bg-gradient-to-b from-[#F0F6FF]/60 to-white pt-8 pb-14 sm:pt-12 sm:pb-20 px-4 sm:px-6 border-b border-gray-100">
                ...
                <div className="relative z-10 max-w-7xl mx-auto">
                    <button
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center gap-2 text-[#575A5F] hover:text-[#0056b3] transition-colors text-[14px] sm:text-[15px] font-medium mb-6 sm:mb-8 relative z-20"
                    >
                        <ArrowLeft size={18} />
                        <span>Go Back</span>
                    </button>
                    <div className="max-w-4xl mx-auto flex flex-col items-center gap-3 sm:gap-4 text-center">
                ...
                <div className="space-y-8 lg:space-y-10">
                    <div className="space-y-4 text-center lg:text-left">
                        ...
                        <div className="space-y-4 text-[14px] sm:text-[15px] leading-relaxed text-left balance">
                            <p>
                                Healthy Hearts Gurgaon was founded by{' '}
                                <strong className="text-[#0b1b36] font-semibold">
                                    {DOCTOR.name}
                                </strong>
                                , with a singular mission — to bring world-class
                                interventional cardiology to the NCR region with
                                a human touch.
                                {DOCTOR.bioPara1}
                            </p>
                            <p>{DOCTOR.bioPara2}</p>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 bg-[#F8FAFC] p-5 sm:p-6 rounded-2xl">
                        {STATS.map((s, i) => (
                            <div key={i} className="text-center p-2">
                                <p className="text-[20px] sm:text-[24px] font-bold text-[#0b1b36] tracking-tight leading-none mb-2">
                                    {s.value}
                                </p>
                                <p className="text-[10px] sm:text-[11px] font-bold uppercase text-[#575A5F] tracking-wider leading-tight">
                                    {s.label}
                                </p>
                            </div>
                        ))}
                    ...
                    <div className="bg-[#0b1b36] rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-12 grid grid-cols-1 md:grid-cols-[1fr_1px_1fr] gap-8 md:gap-10 lg:gap-16 items-stretch relative overflow-hidden shadow-xl">
                        ...
                        <div className="space-y-3.5 relative z-10">
                            <h2 className="text-[20px] sm:text-[24px] font-semibold text-white flex items-center gap-2.5">
                                <span className="w-5 h-[2px] bg-[#00a896]" />{' '}
                                Our Approach
                            </h2>
                        ...
                        <div className="space-y-3.5 relative z-10">
                            ...
                            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 pt-1">
                                {ABOUT_US.vision.goals.map(
                                    (goal: string, i: number) => (
                                        <li
                                            key={i}
                                            className="flex items-center gap-2 text-[14px] sm:text-[15px] text-white/90 truncate"
                                        >
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                <div className="space-y-6 sm:space-y-8">
                    <h2 className="text-[22px] sm:text-[24px] font-semibold text-[#0b1b36] flex items-center gap-3 tracking-tight">
                        <GraduationCap className="text-[#0056b3] shrink-0" />{' '}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="min-w-0">
                                        <p className="font-semibold text-[#0b1b36] text-[15px] sm:text-[16px] leading-snug">
                                            {d}
                                        </p>
                                        <p className="text-[13px] sm:text-[14px] text-[#575A5F] mt-0.5 leading-normal balance">
                                            {inst}
                                        </p>
                                        <p className="text-[11px] sm:text-[12px] font-bold text-[#0056b3] mt-1">
                                            {year}
                                        </p>
                                    </div>
                                </li>
                ...
                <div className="space-y-6 sm:space-y-8">
                    <h2 className="text-[22px] sm:text-[24px] font-semibold text-[#0b1b36] flex items-center gap-3 tracking-tight">
                        <MapPin className="text-[#0056b3] shrink-0" />{' '}
                    ...
                    <div className="space-y-6 sm:space-y-8 border-l-2 border-gray-100 ml-4 sm:ml-5 pl-6 sm:pl-8">
                        {[
                            ...
                            {
                                role: 'Officer Commanding and Physician',
                                org: 'IMTRAT, Bhutan',
                            },
                            {
                                role: 'Various Corporate Hospitals (Delhi NCR)',
                                org: 'Leadership Cardiology Roles',
                            },
                            {
                                role: 'Fellowship in Cardiac Electrophysiology',
                                org: 'Holy Family Hospital, Bandra ,Mumbai',
                            },
                            {
                                role: 'Associate Chief Physician',
                                org: 'Dept of Cardiology, Fuwai Hospital, Beijing, China',
                            },
                        ].map((c, i) => (
                            <div key={i} className="relative">
                                ...
                                <p className="text-[13px] sm:text-[14px] text-[#575A5F] mt-0.5 leading-normal">
                                    {c.org}
                                </p>
                            </div>
                        ))}
            ...
            <section className="bg-[#FCFDFF] py-14 sm:py-20 border-y border-gray-100">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <ul className="flex flex-col gap-3.5">
                                {CLINIC_SERVICE.map(
                                    (
                                        ...
                                        <li
                                            key={i}
                                            className="flex items-start gap-3 text-[14px] sm:text-[15px] leading-relaxed text-[#575A5F]"
                                        >
                                            <CheckCircle2
                                                size={18}
                                                className="text-[#00a896] shrink-0 mt-0.5"
                                                strokeWidth={1.5}
                                            />
                                            <Link
                                                to={`/services/${s.slug}`}
                                                className="hover:text-[#0056b3] transition-colors truncate"
                                            >
                                                {s.title}
                                            </Link>
                                        </li>
                                ...
                                {HOSPITAL_SERVICES.map(
                                    (
                                        ...
                                        >
                                            <CheckCircle2
                                                size={18}
                                                className="text-[#0056b3] shrink-0 mt-0.5"
                                                strokeWidth={1.5}
                                            />
                                            <Link
                                                to={s.path}
                    ...
                    <h3 className="text-[18px] sm:text-[20px] font-semibold text-[#0b1b36] mb-5 sm:mb-6 text-center flex items-center justify-center gap-2.5 tracking-tight">
                        <Award className="text-[#00a896] shrink-0" />{' '}
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
                        {DOCTOR.clinicalFocus.map((area, i) => (
                            <div
                                key={i}
                                className="bg-white p-3 sm:p-4 rounded-xl border border-gray-100 shadow-sm text-center text-[13px] sm:text-[14px] font-medium hover:border-[#0056b3] hover:text-[#0056b3] transition-colors flex items-center justify-center min-h-[56px] balance"
                            >
                                {area}
                            </div>
                        ))}
            ...
            <section className="py-14 sm:py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16">
                    <div className="space-y-6 sm:space-y-8">
                        ...
                        <ul className="flex flex-col gap-4 sm:gap-5">
                            {ABOUT_US.approach.map((p: string, i: number) => (
                                ...
                                >
                                    ...
                                    <span className="text-[14px] sm:text-[15px] text-[#575A5F] leading-relaxed pt-0.5 balance">
                                        {p}
                                    </span>
                                </li>
                            ))}
                        ...
                        <ul className="flex flex-col gap-3.5 sm:gap-4 pt-2">
                            {ABOUT_US.principles.map((p: string, i: number) => (
                                <li
                                    key={`prin-${i}`}
                                    className="flex items-start gap-3.5 p-4 sm:p-5 rounded-xl bg-[#FCFDFF] border border-gray-100"
                                >
                                    <CheckCircle2
                                        size={20}
                                        className="text-[#00a896] shrink-0 mt-0.5"
                                        strokeWidth={1.5}
                                    />
                                    <span className="text-[14px] sm:text-[15px] text-[#575A5F] leading-relaxed balance">
                                        {p}
                                    </span>
                                </li>
                            ))}
                    ...
                    <div className="space-y-6 max-w-2xl mx-auto md:mx-0 w-full">
                        ...
                        <div className="bg-[#F8FAFC] p-6 sm:p-8 rounded-2xl border border-gray-100 flex flex-col gap-6 items-start text-left">
                            <div className="flex gap-4 items-center">
                                <BookOpen
                                    size={28}
                                    className="text-[#00a896] shrink-0"
                                />
                                <p className="text-[14px] sm:text-[15px] leading-relaxed font-medium text-[#0b1b36]">
                                    Dr. Mehta has contributed actively to
                                    peer-reviewed clinical literature with
                                    impactful medical discoveries, systematic
                                    reviews, and structural heart case reports:
                                </p>
                            </div>
                            <ol className="list-decimal list-outside pl-5 space-y-5 text-[13px] sm:text-[14px] text-[#575A5F] border-t border-gray-200/60 pt-5 w-full">
                                {PUBLICATIONS_DATA.map((pub, idx) => (
                                    <li
                                        key={idx}
                                        className="leading-relaxed pl-1"
                                    >
                                        <span className="text-[#0b1b36] font-medium">
                                            {pub.authors} "{pub.citation}"
                                        </span>{' '}
                                        <span className="italic font-medium text-[#0056b3]">
                                            {pub.journal}
                                        </span>{' '}
                                        ...
                                        {pub.doi && (
                                            <span className="block text-[12px] text-gray-400 mt-0.5 font-mono">
                                                DOI: {pub.doi}
                                            </span>
                                        )}
                                    </li>
