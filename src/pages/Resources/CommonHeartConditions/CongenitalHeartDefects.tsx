...
import { CHD_RESOURCE } from '../../../data/siteData';
import CHD from '../../../assets/Resource/Congenital-Heart-Disease.jpg';

const CongenitalHeartDefectsPage: React.FC = () => {
    const data = CHD_RESOURCE;

    return (
        <ResourceLayout currentSlug={data.slug} imageSrc={CHD}>
...
export default CongenitalHeartDefectsPage;