...
import { HEART_RESOURCE } from '../../../data/siteData';
import anginaHeroImage from '../../../assets/Resource/angina-chest-pain.webp';

const DiabetesHeartPage: React.FC = () => {
    const data = HEART_RESOURCE;
        ...
        <ResourceLayout currentSlug={data.slug} imageSrc={anginaHeroImage}>
            <div className="space-y-8">
                ...
                <div className="text-[#575A5F] text-[15.5px] leading-[1.75] space-y-6">
                    <p className="text-lg text-[#0b1b36] font-medium">
                        {data.overview}
                    </p>
                    ...
                    <div className="space-y-6">
                        {data.impact.items.map((item, i) => (
                            <div
                                key={i}
                                className="pl-4 border-l-2 border-[#0056b3]"
                            >
